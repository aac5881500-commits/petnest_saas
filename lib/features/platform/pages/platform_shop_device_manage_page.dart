          ...
          IconButton(
            ...
            onPressed: () async {
              ...
              ScaffoldMessenger.of(
                context,
              ).showSnackBar(const SnackBar(content: Text('已解除鎖定並開啟全部攝影機')));
            },
          ),
          IconButton(
            tooltip: '一鍵關閉全部攝影機',
              ...
              final ok = await showDialog<bool>(
                ...
                builder: (dialogContext) {
                  return AlertDialog(
                    ...
                    content: const Text('確定要關閉並鎖定這間店的所有攝影機嗎？\n店家將無法自行重新開啟。'),
                    actions: [
                      TextButton(
                        onPressed: () => Navigator.pop(dialogContext, false),
                        child: const Text('取消'),
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Icon(
                            type == 'camera' ? Icons.videocam : Icons.sensors,
                            color: platformLocked
                                ? Colors.red
                                : Colors.blueGrey,
                          ),
                      ...
                      if (lockedReason.isNotEmpty) Text('鎖定原因：$lockedReason'),
                      if (url.isNotEmpty) ...[
                        ...
                        SizedBox(
                          ...
                          child: OutlinedButton.icon(
                            onPressed: () async {
                              ...
                              if (uri == null || !url.startsWith('https://')) {
