...
class PlatformActivationCodeManagePage extends StatefulWidget {
  ...
  @override
  State<PlatformActivationCodeManagePage>
      createState() =>
...
class _PlatformActivationCodeManagePageState
    extends State<
        PlatformActivationCodeManagePage> {
  final _codeController =
      TextEditingController();

  final _maxUsesController =
      TextEditingController(text: '1');

  final _freeDaysController =
          ...
          fontWeight: FontWeight.w800,
                      ...
                      SizedBox(
                        ...
                        child:
                          ...
                          onPressed:
                              () async {
                            await PlatformActivationCodeService
                                .instance
                                .updateCodeEnabled(
                              codeId: doc.id,
                              enabled:
