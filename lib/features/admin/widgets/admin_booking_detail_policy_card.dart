...
// 功能說明：店主訂單詳細條款摘要：住宿／安親共用，保留查看當時條款
...
class AdminBookingDetailPolicyCard extends StatelessWidget {
  ...
  Future<void> _open(BuildContext context) async {
    ...
    final dynamic version = data['policyVersion'];
    if (shopId.isEmpty || version == null || version == 0) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('舊訂單／尚無條款簽署紀錄')));
      return;
    }
