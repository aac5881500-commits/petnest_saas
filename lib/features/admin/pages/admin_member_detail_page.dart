    ...
    children: [
      ...
      Row(
        children: [
          ...
          Expanded(
            child: Text(
              data['emergencyContact']?['relation'] ?? '未填',
              style: const TextStyle(fontSize: 15),
            ),
          ),
        ],
      ...
      Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              data['emergencyContact']?['address'] ?? '未填',
              style: const TextStyle(fontSize: 15),
            ),
          ),
        ],
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    if ((data['medicalStatus'] ?? '').toString().isNotEmpty)
                      _smallBadge('醫療注意', Colors.red),

                    if ((data['staffNote'] ?? '').toString().isNotEmpty)
