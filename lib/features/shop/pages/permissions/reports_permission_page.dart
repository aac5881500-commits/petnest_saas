...
class ReportsPermissionPage extends StatefulWidget {
  ...
  @override
  State<ReportsPermissionPage> createState() =>
      _ReportsPermissionPageState();
}
      ...
      body: ListView(
        ...
        children: [
          PermissionSwitchTile(
            ...
            value:
                widget.permissions[ShopPermissionKeys.viewReports] ?? false,
          ...
          PermissionSwitchTile(
            ...
            value:
                widget.permissions[ShopPermissionKeys.viewActionLogs] ??
                    false,
            enabled: widget.isOwner,
            onChanged: (value) {
              _updatePermission(
