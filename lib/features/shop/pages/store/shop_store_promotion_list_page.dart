...
class _ShopStorePromotionListPageState
  ...
  Future<void> _duplicate(StorePromotionModel item) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('已複製活動，預設停用，請改日期後再啟用')),
    );
  }
        ...
        builder: (
          ...
          if (all.isEmpty) {
            return StoreEmptyState(
              title: '尚未建立活動',
              subtitle: '可建立：套裝優惠、多件優惠、分類優惠、滿額優惠。\n'
                        ...
                        builder: (
                          ...
                          return ListView.separated(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              final StorePromotionModel item = items[index];
                              ...
                              return StorePromotionCard(
                                ...
                                onArchive: widget.canManage
                                    ? () => _archive(item)
                                    : null,
                                onOpenProduct: firstProductId != null &&
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute<void>(
                                            builder: (_) =>
                                              ...
                                              shopId: widget.shopId,
                                              product: products[firstProductId],
                                            ),
                                          ),
                                        );
                                      }
