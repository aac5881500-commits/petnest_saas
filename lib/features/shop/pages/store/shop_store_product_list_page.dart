                ...
                builder: (
                  ...
                  final Map<String, String> categoryNames = <String, String>{
                    for (final StoreCategoryModel item
                        in categorySnap.data ?? const <StoreCategoryModel>[])
                      item.id: item.name,
                  };
                  ...
                  final List<StoreProductModel> products = all.where((
                    ...
                    final bool matchesSearch = key.isEmpty ||
                  ...
                  return StreamBuilder<List<InventoryItemModel>>(
                    ...
                    builder: (
                      BuildContext context,
                      AsyncSnapshot<List<InventoryItemModel>> inventorySnap,
                    ) {
