        ...
        builder: (
          ...
          return StreamBuilder<List<StoreProductModel>>(
            ...
            builder: (
                        ...
                        trailing: IconButton(
                          ...
                          onPressed: () {
                            StoreCartService.instance.setBundle(
                              shopId: shopId,
                              bundlePromotionId: cartItem.bundlePromotionId,
                              quantity: 0,
                            );
                          },
                        ),
              ...
              final StoreCartQuote quote = StorePricingService.instance.quoteCart(
                products: allProducts,
                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              if (quote.quantityDiscount > 0)
                                _CartTotalRow(
                                  label: quote.quantityPromotion?.name.isNotEmpty ==
                                          true
                              ...
                              if (quote.amountDiscount > 0)
                                _CartTotalRow(
                                  label: quote.amountPromotion?.name.isNotEmpty ==
                                          true
