// 檔案名稱：lib/features/shop/pages/storefront/store_bundle_detail_page.dart
// 功能說明：套裝優惠內容與加入購物車
        ...
        return StreamBuilder<List<StoreProductModel>>(
          ...
          builder:
              (
                ...
                final StoreBundleQuote quote = StorePricingService.instance
                    .quoteBundle(
                      promotion: widget.promotion,
                      sets: sets,
                      products: products,
                        ...
                        return Scaffold(
                          ...
                          body: ListView(
                            ...
                            children: <Widget>[
                              ...
                              ...widget.promotion.bundleItems.map((
                                StoreBundleItem item,
                              ) {
                                StoreProductModel? product;
                                for (final StoreProductModel candidate
                                    in products) {
