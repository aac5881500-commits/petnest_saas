        ...
        return StoreEnabledPromotionsBuilder(
          ...
          builder: (
            ...
            final StorePricedLine line =
                StorePricingService.instance.quoteProduct(
              product: product,
              quantity: quantity,
            ...
            return StreamBuilder<Map<String, dynamic>>(
              ...
              builder: (
                ...
                final Color primaryBtn = look.primaryButtonColor(theme);
                final Color secondaryBtn = look.secondaryButtonColor(theme);
              ...
              body: ListView(
                ...
                children: <Widget>[
                  ...
                  if (line.itemPromotionType ==
                    ...
                    _BogoCard(theme: theme, line: line, quantity: quantity),
                  ],
                  const SizedBox(height: 12),
                  StoreAvailabilityView(
                    ...
                    color: outOfStock
                        ...
                        : theme.textColor.withValues(alpha: 0.68),
                  ),
                  if (outOfStock)
                    const Padding(
                  ...
                  _QuantitySelector(
                    ...
                    onDown: () => setState(() => _quantity = quantity - 1),
                    onUp: () => setState(() => _quantity = quantity + 1),
                  ),
                        ...
                        Expanded(
                          child: OutlinedButton.icon(
                            style: OutlinedButton.styleFrom(
                              ...
                              side: BorderSide(color: secondaryBtn),
                            ),
                            ...
                            label: Text(outOfStock ? '目前缺貨' : '加入購物車'),
                          ),
                        ),
                        const SizedBox(width: 8),
                        Expanded(
                          child: FilledButton(
                            style: FilledButton.styleFrom(
                              ...
                              foregroundColor:
                                  StoreAppearanceSetting.onColor(primaryBtn),
                            ),
                            onPressed: outOfStock
                                ? null
                                : () async {
                            ...
                            child: Text(outOfStock ? '目前缺貨' : '立即購買'),
                          ),
                        ),
                      ],
                    ),
