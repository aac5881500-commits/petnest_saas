...
void main() {
  testWidgets('有寵物也不再顯示照護提醒卡與點擊查看', (WidgetTester tester) async {
    ...
    expect(find.byType(AdminBookingPetCareReminderCard), findsNothing);
    expect(find.textContaining('點擊查看'), findsNothing);
    expect(find.text('咪'), findsOneWidget);
  });
}
